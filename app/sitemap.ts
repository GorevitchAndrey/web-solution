...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: "how-much-does-a-website-cost-in-calgary", priority: 0.8 },
    { path: "how-to-choose-a-web-developer-in-calgary", priority: 0.8 },
    { path: "website-redesign-calgary-guide", priority: 0.8 },
